...
<section class="content-block text-cards container">
	<div class="row">
		<?php if (get_sub_field('first_content') == 'intro_text') { ?>
				...
				<article class="card">
					...
					<?php if (have_rows('button')) {
						while (have_rows('button')) { the_row(); ?>
							<a href="<?php echo esc_url(get_sub_field('link')); ?>" class="card-link link"><?php echo get_sub_field('label'); ?></a>
						<?php }
					} ?>
				</article>
		...
		<?php if (get_sub_field('first_content') == 'cards') { ?>
